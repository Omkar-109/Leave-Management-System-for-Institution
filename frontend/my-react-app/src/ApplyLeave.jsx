        ...
        <>
            ...
            <form className="leave-form" onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="form-group">
                    ...
                    <div>
                        <input type="radio" name="hqLeave" value="Yes" onChange={() => setIsHqLeave("Yes")} /> Yes
                        <input type="radio" name="hqLeave" value="No" onChange={() => setIsHqLeave("No")} /> No
                    </div>
                </div>
                ...
                <div className="form-group">
                    ...
                    <div>
                        <input type="radio" name="confidential" value="Yes" onChange={() => setIsConfidential("Yes")} /> Yes
                        <input type="radio" name="confidential" value="No" onChange={() => setIsConfidential("No")} /> No
                    </div>
                </div>
